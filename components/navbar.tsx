      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between py-4 md:py-5">
        ...
        <Link href="/" className="flex items-center no-underline group">
          <div className="relative">
            <span className="font-serif text-[32px] font-bold text-[#C9A227] leading-none transition-transform group-hover:scale-105">
              2
            </span>
            <span className="font-serif text-[32px] font-bold text-white leading-none transition-transform group-hover:scale-105">
              I
            </span>
          </div>
