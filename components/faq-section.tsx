...
const faqItems = [
  {
    ...
    answer: "En 4 étapes simples : 1) Choisissez votre formation dans le catalogue depuis votre téléphone (programme, durée, certificat et tarif détaillés). 2) Payez en Mobile Money via Wave, Orange Money ou Free Money — l'accés est activé instantanement. 3) Apprenez à votre rythme avec des vidéos HD, des fiches PDF téléchargéables, des quiz et des exercices pratiques, depuis n'importe où. 4) Obtenez votre certificat numérique Incub Institut, vérifiable en ligne et reconnu par les employeurs.",
  },
  {
    question: "Les diplômes 2I Online sont-ils reconnus par l'Etat ?",
    answer: "Oui. Incub Institut est un centre de formation agrée. Les certifications CAP HCR (Cuisine, Patisserie, Serveur) sont des diplômes nationaux reconnus par l'Etat Sénégalais et par les partenaires employeurs de la filiére hôtellerie-restauration en Afrique de l'Ouest.",
  },
  {
    question: "Comment se déroulent les évaluations et les examens ?",
    answer: "Les cours se déroulent en ligne à votre rythme (vidéos, fichés PDF, quiz). Les évaluations pratiques et les examens certificatifs se déroulent en présentiel à Bargny ou dans un centre partenaire proche de chez vous. Vous serez informés des dates avec suffisamment d'avance pour vous organiser.",
  },
  {
    question: "Puis-je payer en plusieurs fois ?",
    answer: "Oui, le paiement fractionne est possible. Nous proposons des modalités flexibles adaptées aux réalités africaines — en plusieurs tranches mensuelles via Mobile Money (Wave, Orange Money) ou virement bancaire. Contactez-nous sur WhatsApp pour convenir d'un calendrier de paiement personnalisé.",
  },
  {
    question: "Est-ce accessible depuis n'importe quel pays d'Afrique ?",
    answer: "Absolument. La plateforme 2I Online est accessible depuis n'importe quel appareil connecté — smartphone, tablette ou ordinateur — sur tout le continent africain. Certains modules peuvent même etre téléchargés pour etre consultés hors connexion.",
  },
  {
