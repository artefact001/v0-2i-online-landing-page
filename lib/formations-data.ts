...
export const formations: FormationDetail[] = [
  ...
  },
  {
    ...
    longDesc:
      "Le Certificat Professionnel de Spécialité Patissier est une formation de 6 mois pour approfondir votre maîtrise de la pâtisserie. Un choix parfait pour se spécialiser.",
    objectives: [
  ...
  },
  {
    ...
    longDesc:
      "C'est un programme de 3 mois destiné aux jeunes et aux femmes porteurs de projet de le secteur de l'alimentation de rue. De l'idée au lancement, nous vous accompagnons dans la construction de votre projet.",
    objectives: [
